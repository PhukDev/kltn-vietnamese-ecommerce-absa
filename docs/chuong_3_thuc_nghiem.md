...
Dựa trên số liệu thống kê tại Bảng 2, ta có thể rút ra một số nhận xét khoa học quan trọng về đặc trưng phân bổ dữ liệu:
